...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
		...
		\draw[blue, ->, thick] (0,3.5) -- (6,3) node[above, midway, sloped]{pkt1};
        \draw[blue, ->, thick] (6,2.5) -- (0,2) node[above, midway, sloped]{ACK1};
		\draw[blue, ->, thick] (0,1) -- (6,0.5) node[above, midway, sloped]{pkt0};
        \draw[blue, ->, thick] (6,0) -- (0,2) node[above, midway, sloped]{ACK0};
    \end{tikzpicture}
    \caption{分组丢失}
\end{figure}